...
public class NPCWalker : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (isGoingToShop)
        {
            ...
            return; // STOP HERE! Do not run the wandering code below.
        }
    ...
    {
        isStopped = false; // NOW they are allowed to move again
    ...
    public void GoToShop()
    {
        ...
        if (door != null) 
        {
            ...
            // Note: We do NOT set isStopped = false here. 
            // We wait for EndConversation() to release the NPC.
        }
        else
        {
